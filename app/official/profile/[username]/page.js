            ...
            <div className="bg-slate-800 w-[96%] h-96 mt-10 mb-5 mx-auto rounded-xl overflow-y-auto overflow-x-hidden scrollbar-hidden">
                <div className="w-full flex flex-col justify-center mt-3">
                    <div className="flex flex-col justify-center items-center">
                        <p className="text-gray-400 text-[30px] font-bold font-serif">Applications</p>
                        <hr className="border-gray-400 w-[10%]" />
                    </div>
                    <div className="text-gray-400 m-10 mt-2 text-[24px]">
                        <div className="flex gap-3 mt-6 w-[100%]">
                            <div className='w-[92%]   flex gap-5'>
                                <img className="w-8 h-8" src="../../image1.png" alt="Recommendation Image" />
                                <div className='w-[85%]'>
                                    <p className='truncate-text'>Need Funds for 2 girls and 1 boys washrooms Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae architecto, enim cumque qui et aut rem ipsam dolor maiores neque sunt, beatae hic consequatur corrupti quia est. Doloribus, molestias aspernatur!</p>
                                </div>
                            </div>
                            <div className='w-[7%]  '>
                                <button type="button" class=" text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Review</button>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3 mt-6 w-[100%]">
                            <div className='w-[92%]   flex gap-5'>
                                <img className="w-8 h-8" src="../../image1.png" alt="Recommendation Image" />
                                <div className='w-[85%]'>
                                    <p className='truncate-text'>Need Funds for 2 girls and 1 boys washrooms</p>
                                </div>
                            </div>
                            <div className='w-[7%]  '>
                                <button type="button" class=" text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Review</button>
